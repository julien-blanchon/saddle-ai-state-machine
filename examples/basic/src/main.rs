...
//!
//! Demonstrates the simplest possible state machine: two states (`Idle` and
//! `Run`) with a timed transition. A 3D sphere changes color to reflect the
//! active state, and lifecycle messages are logged to the console.
...
fn setup_machine(
    ...
    // Two states: Idle → Run (after 1 second)
...
// ---------------------------------------------------------------------------
// Visual feedback — change sphere color based on active state
// ---------------------------------------------------------------------------
